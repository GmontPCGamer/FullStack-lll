package com.valledelsol.reportes.exception;
...
@DisplayName("Tests - GlobalExceptionHandler (Reportes)")
class GlobalExceptionHandlerTest {
    ...
    void testHandleValidation() {
        ...
        bindingResult.rejectValue("descripcion", "NotBlank", "La descripción es obligatoria");
        bindingResult.rejectValue("ubicacionLatitud", "NotBlank", "La ubicación es obligatoria");
        ...
        assertEquals("La descripción es obligatoria", details.get("descripcion"));
        assertEquals("La ubicación es obligatoria", details.get("ubicacionLatitud"));
    }
